...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if hasattr(insect, 'trueQueen') and insect.trueQueen: # can't remove the true queen
                return None
...
# END Problem 13
    ...
    food_cost = 7
    num_queens = 0
    trueQueen = False # we'll check if it's true (first queen) on init
    implemented = False # Change to True to view in the GUI
    doubled = [] # all the ants with double damage
    # END Problem 9
       ...
       """
        ...
        while place:
            ...
            if ant:
                ...
                if hidden and hidden not in self.doubled: 

                    hidden.damage *= 2
                    self.doubled.append(hidden)

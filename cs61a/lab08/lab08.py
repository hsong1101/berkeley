...
def make_to_string(front, mid, back, empty_repr):
    ...
    def fn(lnk):
        if lnk is Link.empty:
            ...
            return front + str(lnk.first)+ mid + fn(lnk.rest) + back
...
def add_trees(t1, t2):
    ...
    4
      ...
      5
    """
    br1 = [b for b in t1.branches]
    br2 = [b for b in t2.branches]
    stems = [add_trees(b1, b2) for b1, b2 in zip(br1, br2)]
    ...
    return Tree(t1.label + t2.label, stems)

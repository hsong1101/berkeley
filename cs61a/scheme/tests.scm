...
(define ohmygod 1234567890)
; expect ohmygod 

ohmygod 
; expect 1234567890

(define sub-simple (lambda (x) (- x 1)))
; expect sub-simple

(sub-simple 11)
; expect 10

(define mult-simple (lambda (x) (* x 10)))
; expect mult-simple

(mult-simple 5)
; expect 50

(define (dontknowwhatimdoing x y)
  (and (= x y) (* x y) (- x y))) 
; expect dontknowwhatimdoing

(dontknowwhatimdoing 3 3)
; expect 0

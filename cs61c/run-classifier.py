...
if __name__ == "__main__":
    training_data_file = "/home/ff/cs61c/data/yelp-data/yelp-reviews-train-%s.txt" %sys.argv[1]
    test_data_file = "/home/ff/cs61c/data/yelp-data/yelp-reviews-test-%s.txt" %sys.argv[1]

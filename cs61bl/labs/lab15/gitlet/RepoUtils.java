...
class RepoUtils implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        toStore.index.toBeAdded.put("test1", "111111");
        toStore.index.removed.put("test2", "222222");
        toStore.index.toBeAdded.put("HEAD100-repo", "maste56456r-repo");
        toStore.index.removed.put("Cal555-repo", "Go Bears5646584-repo");
        RepoUtils.storeRepo(toStore);

        // test getRepo()
        Gitlet toGet = RepoUtils.getRepo();
        System.out.println("toRetrieve.toBeAdded HEAD = " + toGet.index.toBeAdded);
        System.out.println("toRetrieve.removed Cal = " + toGet.index.removed);
    }
}
...
class IndexUtils implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        toStore.toBeAdded.put("HEAD100", "maste56456r");
        toStore.removed.put("Cal555", "Go Bears5646584!");
        IndexUtils.storeIndex(toStore);

        Index toRetrieve = IndexUtils.retrieveIndex();

        System.out.println("toRetrieve.toBeAdded HEAD = " + toRetrieve.toBeAdded.get("HEAD100"));
        System.out.println("toRetrieve.removed Cal = " + toRetrieve.removed.get("Cal555"));
    }
}
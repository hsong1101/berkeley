...
class Utils implements Serializable{
    ...
    public static void main( String[] args) throws IOException {
        ...
        Utils.writeContents(Utils.join(pwd.toString(),".gitlet", "REPO"),Utils.serialize(testCommit));
        boolean isExsit = new File("/Users/baovydang/CS61BL/group238/proj2/.gilet/REPO").isFile();
        System.out.println("REPO exists ? : " + isExsit);

//        CommitNode deCommit = (CommitNode) Utils.deserialze(Utils.join(pwd.toString(), "idCommit.ser"));

...
class CommitUtils implements Serializable {
    ...
    public static void serializeCommitNode(CommitNode currCommit) {
        ...
        File firstCommitFile = new File(pwd, ".gitlet/commitNodes/" + currCommit.commitID);
    ...
    /**
     * EXAMPLES:
     * CommitNode lastCommitNode = CommitUtils.deserializeCommitNode(repo.branches.get(repo.branches.get("HEAD")));
